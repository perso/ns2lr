...
class LevelReader(object):
    ...
    def write_mesh(self, stream):
        ...
        faces = (
            Face(0, EdgeLoop({"edge": edges[0], "is_flipped": False}, {"edge": edges[1], "is_flipped": False}, {"edge": edges[2], "is_flipped": False}), 0),
            Face(1, EdgeLoop({"edge": edges[2], "is_flipped": True}, {"edge": edges[3], "is_flipped": False}, {"edge": edges[4], "is_flipped": False}), 1),
        )
        triangles = {
            "number": 2,
            "items": [
